...
// Generate monthly payment estimation
export function calculateMonthlyPayment(price: number, downPayment: number = 0.2, termMonths: number = 60, interestRate: number = 0.12): number {
